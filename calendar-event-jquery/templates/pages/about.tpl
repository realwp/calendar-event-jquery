<?php
    ...
    $cej_plugin_data = get_plugin_data(CEJ_PATH . '/' . CEJ_NAME . '.php')
?>
            ...
            <div id="main-wrapper" class="wow fadeInRight">
                <div class="ym-wrapper">
                    ...
                    <div class="wrap about-wrap">
                        <h1><?php echo $cej_plugin_data['Name']; ?></h1>

                        <p class="about-text"><?php echo $cej_plugin_data['Description']; ?></p>
                        <div class="wp-badge"
                        ...
                        <h2 class="nav-tab-wrapper wp-clearfix">
                            ...
                            <a href="<?php echo $cej_plugin_data['AuthorURI']; ?>" class="nav-tab" data-content="tab-content-2">وابستگی‌ها</a>
                            <a href="<?php echo $cej_plugin_data['AuthorURI']; ?>" data-content="tab-content-3" class="nav-tab">مستندات</a>
                            <a href="<?php echo $cej_plugin_data['AuthorURI']; ?>" class="nav-tab" data-content="tab-content-4">دست&zwnj;اندرکاران</a>
                        </h2>
                        <hr>
                        ...
                        <div class="tab-content tab-content-2">
                            ...
                            <table class="form-table">
                                <tbody>
                                <?php
                                    foreach (unserialize(CEJ_DEPENDENCY) as $cej_item) { ?>
                                        <tr>
                                            <td><?php echo $cej_item['name']; ?></td>
                                            <td><?php echo $cej_item['version']; ?></td>
                                            <td><a href="<?php echo $cej_item['link']; ?>"
                        ...
                        <table class="form-table tab-content tab-content-1 active">
                            ...
                            <tr>
                                <th>نام پلاگین:</th>
                                <td><?php echo $cej_plugin_data['Name']; ?></td>
                            </tr>
                            <tr>
                                <th>نام منحصر:</th>
                                <td><?php echo $cej_plugin_data['TextDomain']; ?></td>
                            </tr>
                            <tr>
                                <th>نسخه:</th>
                                <td><?php echo $cej_plugin_data['Version']; ?></td>
                            </tr>
                            <tr>
                                <th>پشتیبانی از شبکه:</th>
                                <td><?php echo ($cej_plugin_data['Network']) ? 'در دسترس' : 'قابل دسترسی نیست'; ?></td>
                            </tr>
                            <tr>
                                <th>سازنده:</th>
                                <td><?php echo $cej_plugin_data['AuthorName']; ?></td>
                            </tr>
                            <tr>
                                <th>تحت مالکیت:</th>
